...
\begin{enumerate}
    ...
    \begin{trivlist}
        \item $\displaystyle (1, \sin nt) = \int^\pi_{-\pi} \sin nt dt = \frac{1}{n} \cos n\pi - \frac{1}{n} \cos n -\pi = 0$ (так как косинус чётная функция.)
        \item $\displaystyle (1, \cos nt) = \int^\pi_{-\pi} \cos nt dt = \frac{1}{n} \sin n\pi - \frac{1}{n} \sin n -\pi = \frac{2}{n} \sin n\pi = 0$ (так как $n$ - целое число $\sin n\pi = 0$)
    ...
    \end{trivlist}
    Итак, нормированный базис: $\displaystyle {\frac{1}{\sqrt{2\pi}}, \frac{\sin t}{\sqrt{\pi}}, \frac{\cos t}{\sqrt{\pi}}, \dots \frac{\sin nt}{\sqrt{\pi}}, \frac{\cos nt}{\sqrt{\pi}} }$
    ...
    \begin{trivlist}
        ...
        \item $\displaystyle a_n = \int^\pi_{-\pi} \frac{\cos nt}{\sqrt{\pi}} f(t) dt = \frac{1}{\sqrt{\pi}} \int^\pi_{-\pi} -3t \cos nt dt = \frac{-3}{\sqrt{\pi}} \int^\pi_{-\pi} t \cos nb dt =$ \\
        ...
        $\displaystyle \int t \sin(nt) dt = \frac{1}{n} \int t d cod (nt) = -\frac{1}{n}\left(t \cos(nt) - \int \cos(nt) dt\right) = \frac{-\left(t \cos(nt) - \frac{1}{n} \sin(nt)\right)}{n} = -\left(\frac{nt \cos(nt) - \sin(nt)}{n^2}\right)$ \\
